...
//Sets up the radio buttons for the Ajax Pet Gallery for a user to select what type 
	//of cute pet photos they want to see (they should of course, always pick puppies)
	function init() {
...
//Updates the photos displayed on the page based on the current pet selection, fetching the photos from the AJAX Pets API.
...
// Populates the pictures section of the page with the result images,replacing any previous photos. 
